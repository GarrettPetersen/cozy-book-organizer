...
The scene uses a fixed 1000 × 650 game world and scales it to the browser. This keeps physics deterministic and gives future scanned ink assets stable anchor points. Mobile landscape is the primary phone layout; portrait preserves the full room with letterboxing. Matter bodies drive loose books. Shelved books keep a canonical order and persistent gaps, while a heavy monotonic shelf simulation eases each spine toward its supported angle without swinging. Stable books can stand unsupported; end books move at both ends as their bottoms slide outward and they lean back onto a neighbor. Adding support changes their equilibrium so they settle upright again. Rotated-corner bounds keep every book above its shelf board.
